ipheno <- geno_pheno[[19]]$pheno
igeno <- geno_pheno[[19]]$geno
...
igeno <- igeno2
ipheno <- data.frame(id = ipheno$taxa, pheno = ipheno$Seed_NM_PN)

save_geno_pheno(ipheno, igeno, names(geno_pheno)[19])